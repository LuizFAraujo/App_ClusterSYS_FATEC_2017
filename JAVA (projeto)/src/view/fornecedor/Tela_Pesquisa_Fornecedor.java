...
public class Tela_Pesquisa_Fornecedor extends javax.swing.JDialog {
    ...
    //--------------------------------------------------------------------------
    private List<Fornecedor> list_Fornecedores = new ArrayList<>(); // lista completa dos fornecedores
    private List<Fornecedor> list_Search = new ArrayList<>(); // lista para usar em list_Search
    //--------------------------------------------------------------------------
    ...
    public static void setModoEditarUpdate(boolean modoEditarUpdate) {
        Tela_Pesquisa_Fornecedor.modoEditarUpdate = modoEditarUpdate;
    }
    ...
    public Tela_Pesquisa_Fornecedor(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    // modo padrão, apartir dele chama a busca de fornecedor
    public Tela_Pesquisa_Fornecedor(Frame parent, boolean modal, int permissao) {
        super(parent, modal);
        initComponents();
    ...
    public Tela_Pesquisa_Fornecedor(Frame parent, boolean modal,
            int permissao, List<Fornecedor> list) {
        super(parent, modal);
        initComponents();

        list_Fornecedores = list;
    ...
    private void init() {
        ...
        Tools_SetIcon.setIcon(this, "/view/_images/24/fornecedor_consulta_Gnd_24.png");
...
//==============================================================================
    ...
    private void initComponents() {
        ...
        scroll_tb_Fornecedores = new javax.swing.JScrollPane();
        ...
        tb_Fornecedores.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        tb_Fornecedores.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        ...
        tb_Fornecedores.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tb_FornecedoresKeyPressed(evt);
            }
        });
        scroll_tb_Fornecedores.setViewportView(tb_Fornecedores);
        if (tb_Fornecedores.getColumnModel().getColumnCount() > 0) {
            tb_Fornecedores.getColumnModel().getColumn(0).setMinWidth(50);
            tb_Fornecedores.getColumnModel().getColumn(0).setPreferredWidth(50);
            tb_Fornecedores.getColumnModel().getColumn(0).setMaxWidth(50);
            tb_Fornecedores.getColumnModel().getColumn(2).setMinWidth(110);
            tb_Fornecedores.getColumnModel().getColumn(2).setPreferredWidth(110);
            tb_Fornecedores.getColumnModel().getColumn(2).setMaxWidth(110);
            tb_Fornecedores.getColumnModel().getColumn(3).setMinWidth(260);
            tb_Fornecedores.getColumnModel().getColumn(3).setPreferredWidth(260);
            tb_Fornecedores.getColumnModel().getColumn(3).setMaxWidth(260);
        }
        ...
        pnTabListaLayout.setHorizontalGroup(
            ...
            .addGroup(pnTabListaLayout.createSequentialGroup()
                ...
                .addGroup(pnTabListaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnTabListaLayout.createSequentialGroup()
                        .addComponent(scroll_tb_Fornecedores)
                        .addContainerGap())))
        );
        pnTabListaLayout.setVerticalGroup(
            ...
            .addGroup(pnTabListaLayout.createSequentialGroup()
                .addGap(5, 5, 5)
                .addComponent(scroll_tb_Fornecedores, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtNomeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNomeKeyReleased
        ...
        if (evt.getKeyCode() != KeyEvent.VK_UP && evt.getKeyCode() != KeyEvent.VK_DOWN) {
            ...
            if (tb_Fornecedores.getRowCount() > 0) {
                tb_Fornecedores.setRowSelectionInterval(0, 0);
            }
        }
    ...
    private void tb_FornecedoresKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tb_FornecedoresKeyPressed
        // se setas direcionas para cima ou para baixo...
        if (evt.getKeyCode() == KeyEvent.VK_UP || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            refreshButtons(tb_Fornecedores.getSelectedRow(), tb_Fornecedores.getModel().getRowCount());
        }
    }//GEN-LAST:event_tb_FornecedoresKeyPressed
...
// Main
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Pesquisa_Fornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Tela_Pesquisa_Fornecedor dialog = new Tela_Pesquisa_Fornecedor(new javax.swing.JFrame(), true);
...
//==============================================================================
    ...
    private javax.swing.JScrollPane scroll_tb_Fornecedores;
...
//==============================================================================
    ...
    private void refreshCount() {
        lbNumRegistroTab.setText(Tools_Tables.refreshCount(tb_Fornecedores));
    }
    ...
    private void execConfirmar_Editar() {
        if (modoPesquisarLocal) {
            ...
            int id;
            if (tb_Fornecedores.getRowCount() > 0) {
                id = (int) tb_Fornecedores.getValueAt(tb_Fornecedores.getSelectedRow(), 0);
            } else {
                id = 0;
            }

            Tela_Cadastro_Fornecedor tela = new Tela_Cadastro_Fornecedor(null, true, idPermissao, list_Fornecedores, id);
            tela.setVisible(true);

            // se houve alteração...
            if (modoEditarUpdate) {
                list_Fornecedores = Tela_Cadastro_Fornecedor.getList_Fornecedores();
                loadTable(list_Fornecedores);
                txtNome.setText(null);
            }

        } else if (modoBuscarUser) {
            idFound = (int) tb_Fornecedores.getValueAt(tb_Fornecedores.getSelectedRow(), 0);
            dispose();
        }
    }
    ...
    private void navegarAte(String local) {
        ...
        Tools_Tables.valueChangedScrollTable(tb_Fornecedores);
        local = local.toUpperCase();
        int tamTable = tb_Fornecedores.getModel().getRowCount(); // tamanho da lista
        int linha = tb_Fornecedores.getSelectedRow(); // seleção atual
        ...
        if (tamTable > 0) {
            ...
            tb_Fornecedores.setRowSelectionInterval(linha, linha);
        }
    ...
    private void loadTable(List<Fornecedor> list) {

        DefaultTableModel tabela = (DefaultTableModel) tb_Fornecedores.getModel();
        tabela.setNumRows(0); // limpa, para evitar exibir dado duplicado ao inserir dados

        tb_Fornecedores.setRowSorter(new TableRowSorter(tabela)); // para habilitar ordenar atravéz de clique nas colunas da tabala

        DefaultTableCellRenderer center = new DefaultTableCellRenderer();// para colocar a coluna centralizada
        center.setHorizontalAlignment(SwingConstants.CENTER);

        tb_Fornecedores.getColumnModel().getColumn(0).setCellRenderer(center);
        tb_Fornecedores.getColumnModel().getColumn(2).setCellRenderer(center);

        list.forEach((fornecedor) -> {
            tabela.addRow(new Object[]{
                fornecedor.getId(),
                fornecedor.getNome(),
                Tools_Texts.getTelefoneFormated(fornecedor.getTelefone()),
                fornecedor.getEmail()
            });
        });
        ...
        if (tb_Fornecedores.getRowCount() > 0) {
            tb_Fornecedores.setRowSelectionInterval(0, 0);
            refreshButtons(0, tb_Fornecedores.getModel().getRowCount());
        }
    }
    ...
    public void loadSearchTable(String search) {
        ...
        if (list_Fornecedores != null) {

            for (int i = 0; i < list_Fornecedores.size(); i++) {

                String lineFornecedor = list_Fornecedores.get(i).getNome().toUpperCase();
                ...
                switch (op) {
                    case 1:
                        ...
                        if (lineFornecedor.contains(search)) {
                            list_Search.add(list_Fornecedores.get(i)); // adiciona na lista de pesquisa
                        }
                        break;

                    case 2:
                        // se a pesquisa estiver no começo da linha pesquisada
                        if (lineFornecedor.indexOf(search) == 0) {
                            list_Search.add(list_Fornecedores.get(i));
                        }
                        break;

                    case 3:
                        int posSpc = lineFornecedor.lastIndexOf(" "); // posição do ultimo espaço

                        // se a pesquisa estiver no fim da linha pesquisada
                        if (lineFornecedor.lastIndexOf(search) == posSpc + 1) {
                            list_Search.add(list_Fornecedores.get(i));
                        }
                        break;
                }
