...
public class Tela_Cadastro_Fornecedor extends javax.swing.JDialog {
    ...
    //                          GETTERS / SETTERS
    //==========================================================================
    public static List<Fornecedor> getList_Fornecedores() {
    ...
    public Tela_Cadastro_Fornecedor(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public Tela_Cadastro_Fornecedor(Frame parent, boolean modal, int permissao) {
        super(parent, modal);
        initComponents();
    ...
    public Tela_Cadastro_Fornecedor(Frame parent, boolean modal,
            int permissao, List<Fornecedor> list, int fornId) {
        super(parent, modal);
        initComponents();
        Tools_Texts.clearTextsContainer(pnCampos);
        modoEditar = true;
        ...
        loadView(returnIndiceByValueId(fornId)); // carrega dados na tela
    ...
    private void init() {
        ...
        Tools_SetIcon.setIcon(this, "/view/_images/24/fornecedor_cadastro_Gnd_24.png");
...
//==============================================================================
    ...
    private void initComponents() {
        ...
        txtNome.setToolTipText("<html>\n<p>Informar o nome do fornecedor.\n<html/>");
        ...
        txtCNPJ.setToolTipText("Informar o CNPJ.");
        txtCNPJ.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        txtCNPJ.setName(""); // NOI18N
        ...
        pnCamposLayout.setHorizontalGroup(
            ...
            .addGroup(pnCamposLayout.createSequentialGroup()
                ...
                .addGroup(pnCamposLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(pnCamposLayout.createSequentialGroup()
                        .addGroup(pnCamposLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbCNPJ, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnCamposLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {lbCNPJ, txtCNPJ});
    ...
    private void btnNovo_SalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovo_SalvarActionPerformed
        ...
        if (modoNovoLocal) {
            ...
            if (validaTxt()) {
                ...
                //----------------------------------------------------
                int newId = FornecedorDAO.create(fornecedor); // cria novo registro e retorna o id
                ...
                if (newId > 0) {
                    ...
                    Tela_Pesquisa_Fornecedor.setModoEditarUpdate(modoEditarUpdate);
    ...
    private void btnExcluir_CancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluir_CancelarActionPerformed
        ...
        if (modoNovoLocal || modoEdicaoLocal) {
            ...
            if (Tools_Message.showConfirmDelete()) {
                ...
                int tamList = list_Fornecedores.size();
                int posNewShowId = -1; // posição do id a exibir

                for (int i = 0; i < tamList; i++) {
                    fornecedor = list_Fornecedores.get(i);

                    if (fornecedor.getId() > idAtual) {
                        posNewShowId = i;
                        break;
                    } else if (fornecedor.getId() < idAtual) {
                        posNewShowId = i;
                    }
                }
    ...
    private void txtCNPJKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCNPJKeyPressed
        txtCNPJ.setText(txtCNPJ.getText().replaceAll("[^0-9]", ""));
...
// Main
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Cadastro_Fornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Tela_Cadastro_Fornecedor dialog = new Tela_Cadastro_Fornecedor(new javax.swing.JFrame(), true);
...
//==============================================================================
    ...
    private void loadView(int indiceID) {
        ...
        if (indiceID >= 0 && indiceID <= list_Fornecedores.size() - 1) {

            Fornecedor fornecedor = new Fornecedor();
            fornecedor = list_Fornecedores.get(indiceID);

            //-----------------------------------------------------
            // monta informações na tela
            txtCodigo.setText(Integer.toString(fornecedor.getId()));
            txtNome.setText(fornecedor.getNome());
            txtCNPJ.setText(fornecedor.getCnpj());
            txtTelefone.setText(fornecedor.getTelefone());
            txtEmail.setText(fornecedor.getEmail());
            txtRua.setText(fornecedor.getEndereco().getRua());
    ...
    private int returnIndiceByValueId(int id) {
        ...
        if (id > 0) {
            ...
            int tamList = list_Fornecedores.size(); // pega o tamanho da lista (item 1 = index 0)
    ...
    private boolean validaTxt() {
        ...
        if (obj == null) {
            ...
            String strCNPJ = txtCNPJ.getText().replace(" ", "");
            ...
            if (strCNPJ.length() > 4) {
                ...
                Tools_Texts.goToNullObject(txtCNPJ);
            }
    ...
    private void navegarAte(String local) {
        ...
        int tamList = list_Fornecedores != null ? list_Fornecedores.size() : 0;
    ...
    private void setNames() {
        ...
        txtCNPJ.setName(lbCNPJ.getText());
