...
public class Tela_Pesquisa_Usuario extends javax.swing.JDialog {
    ...
    //--------------------------------------------------------------------------
    private List<Usuario> list_Usuarios = new ArrayList<>(); // lista completa dos usuários
    private List<Usuario> list_Search = new ArrayList<>(); // lista para usar em list_Search
    //--------------------------------------------------------------------------
    ...
    public static void setModoEditarUpdate(boolean modoEditarUpdate) {
        Tela_Pesquisa_Usuario.modoEditarUpdate = modoEditarUpdate;
    }
    ...
    public Tela_Pesquisa_Usuario(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    // modo padrão, apartir dele chama a busca de usuario
    public Tela_Pesquisa_Usuario(Frame parent, boolean modal, int permissao) {
        super(parent, modal);
        initComponents();
    ...
    public Tela_Pesquisa_Usuario(Frame parent, boolean modal,
            int permissao, List<Usuario> list) {
        super(parent, modal);
        initComponents();
    ...
    //==========================================================================
    private void init() {
        // para habilitar ordenar atravéz de clique nas colunas da tabala
        tb_Usuarios.setRowSorter(new TableRowSorter((DefaultTableModel) tb_Usuarios.getModel()));
        //----------------------------------------------------------------------
        ...
        Tools_SetIcon.setIcon(this, "/view/_images/24/usuario_consulta_Gnd_24.png");
...
//==============================================================================
    ...
    private void initComponents() {
        ...
        scroll_tb_Usuarios = new javax.swing.JScrollPane();
        ...
        tb_Usuarios.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        tb_Usuarios.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        ...
        scroll_tb_Usuarios.setViewportView(tb_Usuarios);
        if (tb_Usuarios.getColumnModel().getColumnCount() > 0) {
            ...
            tb_Usuarios.getColumnModel().getColumn(2).setMinWidth(120);
            tb_Usuarios.getColumnModel().getColumn(2).setPreferredWidth(120);
            tb_Usuarios.getColumnModel().getColumn(2).setMaxWidth(120);
            tb_Usuarios.getColumnModel().getColumn(3).setMinWidth(120);
            tb_Usuarios.getColumnModel().getColumn(3).setPreferredWidth(120);
            tb_Usuarios.getColumnModel().getColumn(3).setMaxWidth(120);
        }
        ...
        pnTabListaLayout.setHorizontalGroup(
            ...
            .addGroup(pnTabListaLayout.createSequentialGroup()
                ...
                .addGroup(pnTabListaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnTabListaLayout.createSequentialGroup()
                        .addComponent(scroll_tb_Usuarios)
                        .addContainerGap())))
        );
        pnTabListaLayout.setVerticalGroup(
            ...
            .addGroup(pnTabListaLayout.createSequentialGroup()
                .addGap(5, 5, 5)
                .addComponent(scroll_tb_Usuarios, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtNomeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNomeKeyReleased
        ...
        if (evt.getKeyCode() != KeyEvent.VK_UP && evt.getKeyCode() != KeyEvent.VK_DOWN) {
            ...
            if (tb_Usuarios.getRowCount() > 0) {
                tb_Usuarios.setRowSelectionInterval(0, 0);
            }
        }
    ...
    private void tb_UsuariosKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tb_UsuariosKeyPressed
        // se setas direcionas para cima ou para baixo...
        if (evt.getKeyCode() == KeyEvent.VK_UP || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            refreshButtons(tb_Usuarios.getSelectedRow(), tb_Usuarios.getModel().getRowCount());
        }
...
// Main
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Pesquisa_Usuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Tela_Pesquisa_Usuario dialog = new Tela_Pesquisa_Usuario(new javax.swing.JFrame(), true);
...
//==============================================================================
    ...
    private javax.swing.JScrollPane scroll_tb_Usuarios;
...
//==============================================================================
    ...
    private void refreshCount() {
        lbNumRegistroTab.setText(Tools_Tables.refreshCount(tb_Usuarios));
    }
    ...
    private void execConfirmar_Editar() {
        if (modoPesquisarLocal) {
            ...
            int id;
            if (tb_Usuarios.getRowCount() > 0) {
                id = (int) tb_Usuarios.getValueAt(tb_Usuarios.getSelectedRow(), 0);
            } else {
                id = 0;
            }

            Tela_Cadastro_Usuario tela = new Tela_Cadastro_Usuario(null, true, idPermissao, list_Usuarios, id);
            tela.setVisible(true);

            // se houve alteração...
            if (modoEditarUpdate) {
                list_Usuarios = Tela_Cadastro_Usuario.getList_Usuarios();
                loadTable(list_Usuarios);
                txtNome.setText(null);
            }

        } else if (modoBuscarUser) {
            idFound = (int) tb_Usuarios.getValueAt(tb_Usuarios.getSelectedRow(), 0);
            dispose();
        }
    }
    ...
    private void navegarAte(String local) {
        ...
        Tools_Tables.valueChangedScrollTable(tb_Usuarios);
        local = local.toUpperCase();
        int tamTable = tb_Usuarios.getModel().getRowCount(); // tamanho da lista
        int linha = tb_Usuarios.getSelectedRow(); // seleção atual
        ...
        if (tamTable > 0) {
            ...
            tb_Usuarios.setRowSelectionInterval(linha, linha);
        }
    ...
    //==========================================================================
    //==========================================================================
    // carrega a tabela a lista de usuários
    private void refreshList() {
        list_Usuarios = null;
        list_Usuarios = UsuarioDAO.read(); // carrega a lista de usuário
    }
    ...
    private void loadTable(List<Usuario> list) {
        DefaultTableModel tabela = (DefaultTableModel) tb_Usuarios.getModel();
        ...
        if (tb_Usuarios.getRowCount() > 0) {
            tb_Usuarios.setRowSelectionInterval(0, 0);
            refreshButtons(0, tb_Usuarios.getModel().getRowCount());
        }
    }
    ...
    public void loadSearchTable(String search) {
        ...
        if (list_Usuarios != null) {
            ...
            for (int i = 0; i < list_Usuarios.size(); i++) {
                ...
                String lineUser = list_Usuarios.get(i).getNome().toUpperCase();
                ...
                switch (op) {
                    case 1:
                        ...
                        if (lineUser.contains(search)) {
                            list_Search.add(list_Usuarios.get(i)); // adiciona na lista de pesquisa
                        }
                        break;
                    ...
                    case 2:
                        ...
                        if (lineUser.indexOf(search) == 0) {
                            list_Search.add(list_Usuarios.get(i));
                        }
                        break;
